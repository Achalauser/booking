...
function updateSummaryTable() {
  ...
  let totalPayable = 0;
  let summaryTableHTML = `<h2>Date: ${selectedDate}</h2><h2>Time: ${selectedDuration}</h2><h2>Duration: ${calculateDuration(
    selectedDuration
  )}</h2><h2>Tickets & Charges:</h2><table><tr><th>Ticket Category</th><th>Tickets</th><th>Charges</th></tr>`;
